Patterns are regular expressions that can be used to define custom formats for string fields, for example when a phone number must be entered in a very specific way.
